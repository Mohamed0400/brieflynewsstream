...
export const RETIRED_COUNTRY_SOURCE_CODES = [
  ...
  "KUWAIT_TIMES_KW",
  "KUWAIT_LOCAL_KW",
  // Broken publisher feeds (404/403/HTML) — retire to cut collect noise.
  "TELEGRAPH_FINANCE",
  "ILSOLE_EN",
  "REUTERS_EU_BIZ",
  "BUNDESBANK_DE",
  "SAUDI_GAZETTE_SA_HOME",
  "OMAN_OBSERVER_OM",
  "OMAN_DAILY_OM",
  "CBI_IS",
  "LIBYA_HERALD_BANKING",
  "SME_SK",
  "TIMES_ISRAEL_IL",
  "REUTERS_TOPIC_HEALTHCARE_PHARMA",
] as const;
...
const EXPANDED_COUNTRY_SOURCES: CountrySourceSeed[] = [
  ...
  countryRss("EXPANSION_ES", "Expansion", "https://e00-expansion.uecdn.es/rss/portada.xml", "https://www.expansion.com/", "ES", Region.GLOBAL, Category.FINANCE, 88),
  ...
  countryRss("SCMP_HK", "South China Morning Post Business", "https://www.scmp.com/rss/92/feed", "https://www.scmp.com/business", "HK", Region.GLOBAL, Category.FINANCE, 92),
  countryRss("TAIPEI_TIMES_TW", "Taipei Times", "https://www.taipeitimes.com/xml/index.rss", "https://www.taipeitimes.com/", "TW", Region.GLOBAL, Category.MARKETS, 90),
...
export const COUNTRY_SOURCES: CountrySourceSeed[] = [
  ...
  },
  {
    ...
    homepageUrl: "https://www.scmp.com/economy",
    adapter: "rss",
    country: "CN",
    region: Region.GLOBAL,
    defaultCategory: Category.ECONOMICS,
...
const EXTRA_COUNTRY_TOPICS: Array<[string, string, string, Category]> = [
  ["GOLD", "Gold", "(gold OR bullion OR \"precious metals\" OR XAU)", Category.GOLD],
  ["OIL", "Oil", "(oil OR energy OR OPEC OR petroleum OR LNG OR crude)", Category.OIL],
  ...
  ["ENERGY", "Energy", "(energy OR electricity OR gas OR fuel OR power OR utilities)", Category.ENERGY],
];
...
const WIDE_COUNTRY_TOPICS: Array<[string, string, string, Category]> = [
  ...
  ["MINING", "Mining", "(mining OR metals OR commodities OR copper OR silver)", Category.COMMODITIES],
...
/** Raise qualityWeight on desk-critical generated feeds after they are created. */
const FOCUS_SOURCE_WEIGHTS: Record<string, number> = {
  GNEWS_GLOBAL_GOLD: 97,
  GNEWS_GLOBAL_OIL: 93,
  GNEWS_GLOBAL_ECON: 92,
  GNEWS_EU_OIL: 94,
  GNEWS_EU_ECON: 95,
  GNEWS_EU_BANK: 95,
  GNEWS_KW_GOLD: 96,
...
/**
 * High-priority investor desk queries (gold / KW energy / US+global markets).
 * New codes only — existing GNEWS_* rows are boosted via FOCUS_SOURCE_WEIGHTS.
 */
function priorityInvestorSources(): CountrySourceSeed[] {
  return [
    googleNewsSource(
      "GNEWS_GLOBAL_GOLD_PRICE",
      "Global Gold Price",
      "(gold price OR XAUUSD OR bullion OR \"spot gold\" OR \"gold futures\")",
      "GLOBAL",
      "en",
      Category.GOLD,
      98,
    ...
    googleNewsSource(
      "GNEWS_GLOBAL_GOLD_ETF",
      "Global Gold ETF Investment",
      "(gold ETF OR GLD OR \"gold demand\" OR \"central bank gold\" OR \"World Gold Council\")",
      "GLOBAL",
      "en",
      Category.GOLD,
      96,
    ...
    googleNewsSource(
      "GNEWS_GLOBAL_SILVER",
      "Global Silver Metals",
      "(silver OR XAG OR \"precious metals\" OR platinum OR palladium)",
      "GLOBAL",
      "en",
    ...
    googleNewsSource(
      "GNEWS_GLOBAL_OPEC_POWER",
      "OPEC Oil Gas Power",
      "(OPEC OR \"oil production\" OR \"natural gas\" OR LNG OR \"power generation\" OR electricity)",
      "GLOBAL",
      "en",
      Category.OIL,
      94,
    ...
    googleNewsSource(
      "GNEWS_US_GOLD_INVEST",
      "US Gold Investment",
      "United States (gold OR bullion OR \"precious metals\" OR \"gold ETF\" OR XAU)",
      "US",
      "en",
      Category.GOLD,
      96,
    ...
    googleNewsSource(
      "GNEWS_US_FED_MARKETS",
      "US Fed Markets Investment",
      "(\"Federal Reserve\" OR Fed OR \"interest rates\" OR dollar OR Treasury) (markets OR investment OR gold OR inflation)",
      "US",
      "en",
      Category.FINANCE,
      95,
    ...
    googleNewsSource(
      "GNEWS_US_ENERGY_POWER",
      "US Oil Gas Power",
      "United States (oil OR crude OR \"natural gas\" OR LNG OR electricity OR \"power grid\" OR EIA)",
      "US",
      "en",
      Category.ENERGY,
      92,
    ...
    googleNewsSource(
      "GNEWS_KW_GOLD",
      "Kuwait Gold",
      "Kuwait (gold OR bullion OR \"precious metals\" OR ذهب)",
      "KW",
      "en",
      Category.GOLD,
      96,
    ...
    googleNewsSource(
      "GNEWS_KW_OIL_GAS",
      "Kuwait Oil Gas",
      "Kuwait (oil OR petroleum OR \"Kuwait Petroleum\" OR KPC OR KOC OR \"natural gas\" OR LNG OR crude)",
      "KW",
      "en",
      Category.OIL,
      97,
    ...
    googleNewsSource(
      "GNEWS_KW_POWER",
      "Kuwait Power Energy",
      "Kuwait (electricity OR power OR energy OR utilities OR \"Ministry of Electricity\" OR fuel)",
      "KW",
      "en",
      Category.ENERGY,
      95,
    ...
    googleNewsSource(
      ...
      "Kuwait (investment OR \"KIA\" OR \"sovereign wealth\" OR Boursa OR stocks OR economy OR finance)",
      "KW",
      "en",
      Category.FINANCE,
      94,
    ...
    googleNewsSource(
      "GNEWS_KW_OIL_AR",
      "Kuwait Oil Arabic",
      "الكويت (نفط OR بترول OR غاز OR طاقة OR كهرباء OR استثمار OR ذهب)",
      "KW",
      "ar",
      Category.OIL,
      97,
    ...
    googleNewsSource(
      "GNEWS_GLOBAL_GOLD_AR",
      "Global Gold Arabic",
      "(ذهب OR سبائك OR \"أسعار الذهب\" OR معادن)",
      "GLOBAL",
      "ar",
      Category.GOLD,
      94,
    ...
    // Europe investor desk — gold, ECB/markets, energy
    googleNewsSource(
      "GNEWS_EU_GOLD",
      "Eurozone Gold",
      "(Eurozone OR Europe OR ECB OR euro) (gold OR bullion OR \"precious metals\" OR XAU)",
      "EU",
      "en",
      Category.GOLD,
      96,
    ...
    googleNewsSource(
      "GNEWS_EU_INVEST",
      "Europe Investment Markets",
      "(Europe OR Eurozone OR ECB) (investment OR markets OR equities OR bonds OR inflation OR rates)",
      "EU",
      "en",
      Category.FINANCE,
      96,
    ...
    googleNewsSource(
      "GNEWS_EU_ENERGY_POWER",
      "Europe Oil Gas Power",
      "(Europe OR EU OR Eurozone) (oil OR gas OR LNG OR electricity OR \"energy prices\" OR nuclear OR \"power grid\")",
      "EU",
      "en",
      Category.ENERGY,
      95,
    ...
    googleNewsSource(
      "GNEWS_GB_GOLD_INVEST",
      "UK Gold Investment",
      "(UK OR Britain OR London) (gold OR bullion OR \"precious metals\" OR \"Bank of England\" OR gilt)",
      "GB",
      "en",
      Category.GOLD,
      95,
    ...
    googleNewsSource(
      "GNEWS_GB_ENERGY_POWER",
      "UK Oil Gas Power",
      "(UK OR Britain) (oil OR gas OR LNG OR electricity OR \"North Sea\" OR energy OR utilities)",
      "GB",
      "en",
      Category.ENERGY,
      93,
    ...
    googleNewsSource(
      "GNEWS_DE_GOLD_INVEST",
      "Germany Gold Investment",
      "(Germany OR Berlin OR Frankfurt OR Bundesbank) (gold OR bullion OR investment OR markets OR economy)",
      "DE",
      "en",
      Category.GOLD,
      94,
    ...
    googleNewsSource(
      "GNEWS_DE_ENERGY_POWER",
      "Germany Energy Power",
      "(Germany OR Berlin) (energy OR gas OR LNG OR electricity OR \"power prices\" OR oil OR industry)",
      "DE",
      "en",
      Category.ENERGY,
      93,
    ...
    googleNewsSource(
      "GNEWS_FR_GOLD_INVEST",
      "France Gold Investment",
      "(France OR Paris OR \"Banque de France\") (gold OR bullion OR investment OR markets OR economy)",
      "FR",
      "en",
      Category.GOLD,
      93,
    ...
    googleNewsSource(
      "GNEWS_CH_GOLD_INVEST",
      "Switzerland Gold Finance",
      "(Switzerland OR Zurich OR Geneva OR SNB) (gold OR bullion OR banking OR finance OR investment)",
      "CH",
      "en",
      Category.GOLD,
      94,
    ...
    // China / Taiwan / Hong Kong — gold, trade, energy, markets
    googleNewsSource(
      "GNEWS_CN_GOLD_INVEST",
      "China Gold Investment",
      "China (gold OR bullion OR \"precious metals\" OR \"gold reserves\" OR PBOC OR Shanghai)",
      "CN",
      "en",
      Category.GOLD,
      96,
    ...
    googleNewsSource(
      "GNEWS_CN_MARKETS_INVEST",
      "China Markets Investment",
      "China (economy OR markets OR investment OR stocks OR yuan OR trade OR \"property\" OR stimulus)",
      "CN",
      "en",
      Category.FINANCE,
      95,
    ...
    googleNewsSource(
      "GNEWS_CN_OIL_ENERGY",
      "China Oil Gas Power",
      "China (oil OR crude OR LNG OR \"natural gas\" OR electricity OR energy OR coal OR OPEC)",
      "CN",
      "en",
      Category.OIL,
      94,
    ...
    googleNewsSource(
      ...
      "China (trade OR exports OR imports OR tariffs OR commodities OR copper OR metals)",
      "CN",
      "en",
      Category.TRADE,
      93,
    ...
    googleNewsSource(
      "GNEWS_TW_GOLD_INVEST",
      "Taiwan Gold Investment",
      "Taiwan (gold OR bullion OR investment OR markets OR economy OR finance)",
      "TW",
      "en",
      Category.GOLD,
      94,
    ...
    googleNewsSource(
      "GNEWS_TW_TECH_MARKETS",
      "Taiwan Tech Markets",
      "Taiwan (semiconductor OR TSMC OR equities OR markets OR export OR economy OR investment)",
      "TW",
      "en",
      Category.FINANCE,
      95,
    ...
    googleNewsSource(
      "GNEWS_TW_ENERGY_POWER",
      "Taiwan Energy Power",
      "Taiwan (energy OR electricity OR LNG OR gas OR power OR oil OR utilities)",
      "TW",
      "en",
      Category.ENERGY,
      92,
    ...
    googleNewsSource(
      "GNEWS_HK_GOLD_MARKETS",
      "Hong Kong Gold Markets",
      "(\"Hong Kong\" OR HKEX) (gold OR bullion OR markets OR finance OR investment OR yuan)",
      "HK",
      "en",
      Category.GOLD,
      93,
    ...
    googleNewsSource(
      "GNEWS_CN_TW_CROSS",
      "China Taiwan Cross Strait Economy",
      "(China OR Taiwan OR \"cross-strait\") (trade OR investment OR economy OR markets OR semiconductor OR energy)",
      "CN",
      "en",
      Category.ECONOMICS,
      92,
...
export function generatedCountrySources(): CountrySourceSeed[] {
  ...
  for (const source of extra) {
    const boost = FOCUS_SOURCE_WEIGHTS[source.code];
    if (boost != null) source.qualityWeight = boost;
  }
