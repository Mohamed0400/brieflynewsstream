...
export const COUNTRY_CATALOG: CountryRecord[] = [
  ...
  country("CO", "colombian", "Colombia", "Colombian", "🇨🇴", "كولومبيا", "كولومبي", ["bogota", "medellin", "banrep"]),
  country("PE", "peruvian", "Peru", "Peruvian", "🇵🇪", "بيرو", "بيروفي", ["lima", "sol"]),
  country("UY", "uruguayan", "Uruguay", "Uruguayan", "🇺🇾", "أوروغواي", "أوروغواياني", ["montevideo"]),
  country("EC", "ecuadorian", "Ecuador", "Ecuadorian", "🇪🇨", "الإكوادور", "إكوادوري", ["quito", "guayaquil"]),
  country("VE", "venezuelan", "Venezuela", "Venezuelan", "🇻🇪", "فنزويلا", "فنزويلي", ["caracas", "bolivar"]),
  country("BO", "bolivian", "Bolivia", "Bolivian", "🇧🇴", "بوليفيا", "بوليفي", ["la paz", "santa cruz"]),
  country("CR", "costa-rican", "Costa Rica", "Costa Rican", "🇨🇷", "كوستاريكا", "كوستاريكي", ["san jose"]),
  country("PA", "panamanian", "Panama", "Panamanian", "🇵🇦", "بنما", "بنمي", ["panama city", "canal"]),
  country("FI", "finnish", "Finland", "Finnish", "🇫🇮", "فنلندا", "فنلندي", ["helsinki", "bank of finland"]),
  country("GR", "greek", "Greece", "Greek", "🇬🇷", "اليونان", "يوناني", ["athens", "bank of greece"]),
  country("CZ", "czech", "Czech Republic", "Czech", "🇨🇿", "التشيك", "تشيكي", ["prague", "cnb"]),
  country("RO", "romanian", "Romania", "Romanian", "🇷🇴", "رومانيا", "روماني", ["bucharest", "nbr"]),
  country("HU", "hungarian", "Hungary", "Hungarian", "🇭🇺", "المجر", "مجري", ["budapest", "mnb"]),
  country("SK", "slovak", "Slovakia", "Slovak", "🇸🇰", "سلوفاكيا", "سلوفاكي", ["bratislava"]),
  country("HR", "croatian", "Croatia", "Croatian", "🇭🇷", "كرواتيا", "كرواتي", ["zagreb"]),
  country("RS", "serbian", "Serbia", "Serbian", "🇷🇸", "صربيا", "صربي", ["belgrade"]),
  country("BG", "bulgarian", "Bulgaria", "Bulgarian", "🇧🇬", "بلغاريا", "بلغاري", ["sofia"]),
  country("IS", "icelandic", "Iceland", "Icelandic", "🇮🇸", "آيسلندا", "آيسلندي", ["reykjavik", "cbi"]),
  country("SN", "senegalese", "Senegal", "Senegalese", "🇸🇳", "السنغال", "سنغالي", ["dakar", "cfa"]),
  country("CM", "cameroonian", "Cameroon", "Cameroonian", "🇨🇲", "الكاميرون", "كاميروني", ["yaounde", "douala"]),
  country("RW", "rwandan", "Rwanda", "Rwandan", "🇷🇼", "رواندا", "رواندي", ["kigali"]),
  country("ZM", "zambian", "Zambia", "Zambian", "🇿🇲", "زامبيا", "زامبي", ["lusaka", "kwacha"]),
  country("MU", "mauritian", "Mauritius", "Mauritian", "🇲🇺", "موريشيوس", "موريشي", ["port louis"]),
];
